...
class Board extends React.Component {
    ...
    render() {
        ...
        let taskListElements = taskList
            .map((task, index) => (React.createElement(task_tsx_1.default, {"key": index, "index": index, "boardId": this.props.index, "task": task, "onTaskComplete": this.props.onTaskCompletion})));
